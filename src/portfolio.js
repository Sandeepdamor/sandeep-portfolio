...
const skillsSection = {
  title: "What I Do",
  subTitle:
    "PASSIONATE JAVA FULL STACK DEVELOPER FOCUSED ON BUILDING SCALABLE BACKEND SYSTEMS & MODERN WEB APPLICATIONS",
  skills: [
    emoji(
      "⚡ Build RESTful APIs and scalable backend services using Java, Spring Boot, Spring MVC, and Microservices"
    ),
    emoji(
      "⚡ Develop efficient, responsive, and interactive web applications using Angular"
    ),
    emoji(
      "⚡ Implement authentication & authorization using Spring Security and JWT"
    ),
...
const educationInfo = {
  ...
  schools: [
    ...
    {
      schoolName:
        "Government Higher Secondary School, Ranapur, District Jhabua (M.P.)",
